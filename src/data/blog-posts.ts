...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // ── 1 ── TV size guide (featured) ──────────────────────────────────────────
  {
    ...
    relatedSlugs: ["android-tv-vs-google-tv-vs-webos", "led-tv-buying-guide-features", "smart-home-appliances-2025"],
    content: [
      {
        type: "text",
  ...
  // ── 2 ── Air cooler buying tips ────────────────────────────────────────────
  {
    ...
    relatedSlugs: ["commercial-vs-domestic-air-cooler", "air-cooler-maintenance-checklist", "lower-electricity-bill-appliances"],
    content: [
      {
        type: "text",
  ...
  // ── 10 ── Infrared cooktop buying guide ────────────────────────────────────
  {
    ...
    relatedSlugs: ["infrared-vs-gas-cooktop", "extend-infrared-cooktop-lifespan", "lower-electricity-bill-appliances"],
    content: [
      {
        type: "text",
  ...
  // ── 12 ── Air cooler maintenance checklist ─────────────────────────────────
  {
    slug:        "air-cooler-maintenance-checklist",
    title:       "Air Cooler Maintenance Checklist for Every Season",
    excerpt:     "A few simple habits before, during, and after the season keep an air cooler running efficiently for years. Here is the complete checklist.",
    category:    "maintenance",
    readTime:    5,
    publishedAt: "2026-08-06",
    author:      { name: "Elegant Galaxy", role: "Team" },
    tags:        ["air cooler", "maintenance", "cleaning", "summer", "tips"],
    relatedSlugs: ["extend-infrared-cooktop-lifespan", "air-cooler-buying-tips", "commercial-vs-domestic-air-cooler"],
    content: [
      {
        type: "text",
        body: "An air cooler is one of the lowest maintenance appliances in an Indian home, but low maintenance does not mean no maintenance. A handful of simple habits at the start, middle, and end of the season keep the motor, pump, and cooling pads working properly for years instead of months. Here is a complete checklist to follow.",
      },
      {
        type: "text",
        heading: "Before the Season Starts",
        body: "Once temperatures start climbing, pull the cooler out of storage and inspect it before switching it on. Check the honeycomb pads for cracks, mould, or a stiff, brittle texture from sitting dry all winter. Wipe down the cabinet, check that the wheels roll freely, and confirm the power cord and plug show no fraying. A five minute inspection now saves a breakdown on the first hot afternoon.",
      },
      {
        type: "list",
        heading: "Weekly Checks While It Is Running",
        items: [
          "Top up the water tank rather than letting it run dry, since a dry pump burns out quickly",
          "Check the tank for algae or a slippery film and rinse it out if you see either",
          "Confirm the pads are staying evenly wet across their full width, not just at the top",
          "Listen for any new rattling or grinding sound from the motor or blower",
        ],
      },
      {
        type: "tip",
        body: "Add a tablespoon of white vinegar to the tank once a week if your area has hard water. It slows down mineral buildup on the cooling pads and keeps airflow strong.",
      },
      {
        type: "text",
        heading: "Monthly Deep Clean",
        body: "Once a month, drain the tank completely, remove the pads if your model allows it, and rinse them under running water to clear dust and mineral deposits. Wipe the inside of the tank and the pump housing, and check that the pump sits firmly in place. This single monthly habit is the biggest factor in how long the pads and pump last.",
      },
      {
        type: "warning",
        body: "Never leave water sitting in the tank for more than three days if the cooler is switched off. Stagnant water breeds bacteria fast and causes a musty smell that is difficult to remove later.",
      },
      {
        type: "text",
        heading: "Getting the Best Cooling Every Day",
        body: "Cross ventilation matters as much as the cooler itself. Keep a window or door slightly open on the wall opposite the unit so warm air has somewhere to go. A sealed room traps humidity and the cooling effect drops noticeably within an hour.",
      },
      {
        type: "text",
        heading: "End of Season Shutdown",
        body: "When the weather turns, do not simply switch the cooler off and cover it. Drain the tank fully, wipe it dry, and run the fan without water for about thirty minutes so the internals dry out completely. Store the pads separately in a dry place if possible, since pads left wet inside a closed cooler over months are the single biggest cause of mould by the next season.",
      },
      {
        type: "list",
        heading: "End of Season Checklist",
        items: [
          "Drain the tank completely and wipe it dry",
          "Run the fan without water for thirty minutes to dry the internals",
          "Clean or replace the cooling pads before storing",
          "Cover the cooler loosely rather than sealing it in plastic, so trapped moisture can escape",
          "Store it somewhere dry, away from direct sun and rain",
        ],
      },
      {
        type: "quote",
        body: "Most of the repair calls we get after summer trace back to one thing, a cooler stored wet at the end of the previous season. A dry shutdown takes half an hour and prevents almost all of it.",
        attribution: "Ansh Awal, Operations Manager, Elegant Galaxy",
      },
      {
        type: "text",
        heading: "When to Replace Rather Than Repair",
        body: "Cooling pads are inexpensive and worth replacing every season for consistent performance. The pump and motor are built to last several years with the care above. If you are unsure whether your cooler needs a part replaced or a full upgrade, our guide on [what to check before buying an air cooler](/blog/air-cooler-buying-tips) and our comparison of [commercial and domestic air cooler ranges](/blog/commercial-vs-domestic-air-cooler) cover what to look for in a replacement.",
      },
      {
        type: "cta",
        heading: "Browse the Full Air Cooler Range",
        body: "See every Elegant Galaxy air cooler, from compact domestic models to high capacity commercial units, with full specifications and pricing.",
        href: "/products/air-coolers",
        label: "View Air Coolers",
      },
      {
        type: "text",
        heading: "Keeping the Rest of Your Home Running Too",
        body: "An air cooler is not the only appliance that benefits from a seasonal routine. Our guide on [extending the life of your infrared cooktop](/blog/extend-infrared-cooktop-lifespan) covers the same kind of simple, regular habits for your kitchen, and our tips on [washing machine care](/blog/washing-machine-care-tips) round out a full home maintenance routine.",
      },
    ],
  },

  // ── 13 ── Infrared cooktop lifespan ────────────────────────────────────────
  {
    slug:        "extend-infrared-cooktop-lifespan",
    title:       "How to Extend the Life of Your Infrared Cooktop",
    excerpt:     "An infrared cooktop is built to last years with almost no upkeep. A few daily and monthly habits are all it takes to keep the glass surface and heating element performing like new.",
    category:    "maintenance",
    readTime:    4,
    publishedAt: "2026-08-06",
    author:      { name: "Elegant Galaxy", role: "Team" },
    tags:        ["infrared cooktop", "maintenance", "kitchen", "cleaning", "tips"],
    relatedSlugs: ["air-cooler-maintenance-checklist", "infrared-cooktop-buying-guide", "infrared-vs-gas-cooktop"],
    content: [
      {
        type: "text",
        body: "An infrared cooktop has no burner to clean, no grates to scrub, and no gas line to maintain, which is part of why households switch to one. That does not mean it needs zero care. A short daily wipe and a few monthly checks keep the glass surface, heating element, and controls working properly for years.",
      },
      {
        type: "text",
        heading: "After Every Use",
        body: "Let the surface cool completely before cleaning. Most infrared cooktops show a residual heat indicator that tells you when it is safe to touch. Wipe away spills and food residue with a soft cloth while they are still fresh, since anything left to bake onto the glass overnight becomes much harder to remove later.",
      },
      {
        type: "list",
        heading: "Daily Cleaning Steps",
        items: [
          "Wait for the residual heat indicator to turn off before wiping the surface",
          "Use a soft, damp cloth for everyday spills rather than an abrasive scourer",
          "For dried on residue, use a ceramic cooktop cleaner and a plastic scraper held flat against the glass",
          "Dry the surface fully so water spots do not build up over time",
        ],
      },
      {
        type: "warning",
        body: "Never use steel wool, an abrasive scrubber, or a knife to remove stuck on food. Even a small scratch on the glass surface weakens it and can affect how evenly heat spreads across the cooktop.",
      },
      {
        type: "text",
        heading: "Check Your Cookware Regularly",
        body: "A warped or uneven base is one of the most common reasons an infrared cooktop seems to lose power over time. It is rarely the cooktop itself. Every few months, place your regular pots and pans upside down on a flat surface and check for rocking or gaps. Cookware that no longer sits flat should be replaced for efficient heat transfer.",
      },
      {
        type: "tip",
        body: "Rotate heavy pots and pans slightly when you set them down rather than sliding them across the glass. Sliding cookware is the most common cause of fine surface scratches over time.",
      },
      {
        type: "text",
        heading: "Keep the Ventilation Clear",
        body: "Most infrared cooktops have small vents along the back or sides that let heat escape from the element underneath the glass. Keep this area free of dust, cloth, or clutter. A blocked vent makes the unit work harder than it needs to and can trigger the automatic shut off feature during normal cooking.",
      },
      {
        type: "text",
        heading: "Monthly Checks",
        body: "Once a month, unplug the cooktop and check the power cord for any fraying or damage. Wipe down the control panel and buttons with a barely damp cloth, since spilled liquid or grease around the controls is a common cause of unresponsive buttons over time.",
      },
      {
        type: "table",
        heading: "Quick Reference for Infrared Cooktop Care",
        headers: ["Task", "How Often", "Why It Matters"],
        rows: [
          ["Wipe the glass surface",         "After every use",  "Prevents residue from baking on and becoming hard to remove"],
          ["Check cookware for a flat base",  "Every few months", "Keeps heat transfer efficient and cooking times consistent"],
          ["Clear the ventilation area",      "Monthly",          "Stops the unit overheating or shutting off during cooking"],
          ["Inspect the power cord",          "Monthly",          "Catches wear before it becomes a safety issue"],
        ],
      },
      {
        type: "quote",
        body: "The infrared cooktop complaints we hear almost always trace back to cookware or a blocked vent, not the cooktop itself. Look after those two things and the appliance genuinely lasts for years.",
        attribution: "Sanjeev Awal, Owner and Founder, Elegant Galaxy",
      },
      {
        type: "text",
        heading: "If Something Still Feels Off",
        body: "If the cooktop is not heating evenly after checking your cookware and vents, or a power level setting stops responding, [contact our support team](/contact) rather than opening the unit yourself. Our guide on [choosing the right wattage and features when buying an infrared cooktop](/blog/infrared-cooktop-buying-guide) is also useful if you are comparing your current model against a replacement.",
      },
      {
        type: "cta",
        heading: "See the Full Infrared Cooktop Range",
        body: "Compare wattage options, safety features, and pricing across every Elegant Galaxy infrared cooktop.",
        href: "/products/infrared-cooktops",
        label: "View Infrared Cooktops",
      },
      {
