...
/**
 * Fixed WhatsApp button, bottom-left (BackToTop occupies bottom-right).
 * Fades/scales in shortly after mount instead of being present immediately.
 */
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    const id = setTimeout(() => setShown(true), 1400);
  ...
  return (
    <a
      ...
      style={{
        ...
        opacity:        shown ? 1 : 0,
        transform:      shown ? `scale(${hovered ? 1.08 : 1})` : "scale(0.6)",
